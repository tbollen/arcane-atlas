export const emailWrapper = ({
  ...
  <h1 style="font-size: 2rem; font-family: 'courier new', monospace; font-weight: 700; margin-bottom: 1rem; background: linear-gradient(90deg, #9f332b, #683e86); color: white; padding: 0.5rem 1rem; border-radius: 4px; display: flex; align-items: center; justify-content: center;">Arcane Atlas</h1>
